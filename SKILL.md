...
description: Basic programmatic SEO audit â analyze page templates, crawl budget issues, and indexing health. Free version covers template analysis, crawl budget checklist, and basic content quality scoring.
version: 1.0.0
author: Apex Stack
...
1. **Template Analysis** â Identify page templates and evaluate their SEO potential
2. **Crawl Budget Checklist** â Check for common crawl budget issues
3. **Indexing Health** â Identify indexing bottlenecks
4. **Basic Content Quality** â Assess content depth and uniqueness
...
< 20% = critical â content or authority problem
...
*Built by Apex Stack â from real experience running programmatic SEO at scale.*
